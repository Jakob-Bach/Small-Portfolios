...
We implement our experimental design in Python and make our code available online\footnote{\todo{\url{https://github.com/Jakob-Bach/Small-Portfolios}}}.
The code also allows to download and prepare the datasets.
Additionally, we publish the full experimental data, including results\footnote{\todo{\url{https://www.ipd.kit.edu/mitarbeiter/bach/kportfolios.tar.gz}}}.
