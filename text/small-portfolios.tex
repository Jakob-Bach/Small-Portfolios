...
are complex and quite time-consuming.
...
%JB: probaly should use a ratio etc. rather than a an absolute difference, because without context (without knowing solver runtimes), this number is difficult to assess
