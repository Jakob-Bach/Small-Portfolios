...
While \cite{amadini2014empirical} only uses heuristic search algorithms, our study features a broad comparison of different search strategies for portfolios, including an \emph{exact} solution, several \emph{approximate} solutions, and \emph{random sampling}. 
% JB: "several" == two
