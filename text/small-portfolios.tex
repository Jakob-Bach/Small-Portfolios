...
\maketitle
\todo{change title, as we do no only analyze optimal portfolios; mabye "Analyzing Small Portfolios of SAT Solvers"}
\todo{might even drop "small" in favor of the more technical "k-", which was introduced in an inconsistent manner in the commits from 0c0c554a28 on}
...
\todo{What is the difference between performance and quality?}
...
\todo{Harmonize names of approaches; sometimes they have a space, sometimes an underscore, sometimes a hyphen; also, sometimes italic, sometimes not}
