...
The $k$-Portfolio Problem is to find a portfolio $P$ with minimum costs that contains at most $k$ solvers.%
...
\begin{figure*}[t]
	...
	\caption{Objective value for beam-search-portfolios with $w=100$. Random forests with 100 trees. Portfolio performance for test set vbs (orange) and prediction model (blue)}
