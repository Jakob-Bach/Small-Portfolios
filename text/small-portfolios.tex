...
\supplementdetails[subcategory={Experimental data}]{Dataset}{https://doi.org/10.5445/IR/1000146629}
...
As another exact solution for the \emph{K-Portfolio Problem}, Nof and Strichman present an SMT encoding of the problem and solve it with \emph{Z3}~\cite{nof2020real}.
However, we found our re-implementation of their encoding to be slower than our integer-programming formulation.
...
\begin{itemize}
	...
	%MI: not really _novel_: be less pedantic about details discriminating against related work
