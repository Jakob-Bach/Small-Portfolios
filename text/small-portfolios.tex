...
We compare the quality of such approximations to the results of an exact search. For the exact search, we encode the \emph{K-Portfolio Problem} as an integer optimization problem. 
...
We analyze three variants of the \emph{K-Portfolio Problem}, based on different transformations of solver runtimes. %KB: Weiß jeder, was hier gemeint ist? (Ich nicht. Bin aber auch kein Experte.)
